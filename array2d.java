...
public static void main (String [] args )throws Exception
{
	...
	String [] field ={"ID","Produsen","Nama Barang","Harga"};
	String [][]tblHerbal={
...
{"QOW12","Al-Qowam","Mukjizat Kesembuhan dalam Jintan Hitam, Madu, Bawang Putih dan B","14000"}
	...
	System.out.println("==========================");
	System.out.println("1. Pencarian Data menurut ID");
	System.out.println("");
	...
	optionn=Integer.parseInt(br.readLine());
	switch(optionn){
	case 1:
...
System.out.print("masukan id: ");
				...
				for(int k =0;k<tblHerbal.length;k++){
				if(tblHerbal[k][0].equalsIgnoreCase(id)){
						System.out.println(tblHerbal[k][0]+" "+tblHerbal[k][1]+" "+tblHerbal[k][2]+" "+tblHerbal[k][3]);
						angka=1;
						}
						else{
						}
	...
	break;
	case 2 :
	System.out.print("masukan nama produsen : ");
				String produsen=br.readLine();

				for(int k =0;k<tblHerbal.length;k++){
				if(tblHerbal[k][1].equalsIgnoreCase(produsen)){
						System.out.println(tblHerbal[k][0]+" "+tblHerbal[k][1]+" "+tblHerbal[k][2]+" "+tblHerbal[k][3]);
						angkaa=1;
						}
						else{
	...
	System.out.print("masukan nama barang: ");
				...
				for(int k =0;k<tblHerbal.length;k++){
				if(tblHerbal[k][2].equalsIgnoreCase(barang)){
						System.out.println(tblHerbal[k][0]+" "+tblHerbal[k][1]+" "+tblHerbal[k][2]+" "+tblHerbal[k][3]);
						angkaaa=1;
						}
						else{
	...
	System.out.print("masukan harga: ");
				String harga=br.readLine();
					...
					for(int k =0;k<tblHerbal.length;k++){
					if(tblHerbal[k][3].equalsIgnoreCase(harga)){
							System.out.println(tblHerbal[k][0]+" "+tblHerbal[k][1]+" "+tblHerbal[k][2]+" "+tblHerbal[k][3]);
							angkaaaa=1;
							}
							else{
